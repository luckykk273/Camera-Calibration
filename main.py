...
if __name__ == '__main__':
    ...
    # np.savetxt('./CameraCalibration/test/model.txt', model_points[0], delimiter=' ')
    # for i in range(len(sensor_points)):
    #     np.savetxt('./CameraCalibration/test/data' + str(i).zfill(2) + '.txt', sensor_points[i], delimiter=' ')
